...
class QtWidget(QtGui.QMainWindow, ui.Ui_MainWindow):
    ...
    def loadWorkSpaces(self):
		...
		testXML.writeFile('', 'history', 'host', '12.34')
		testXML.writeFile('', 'history', 'username', '12.34')
		testXML.writeFile('', 'history', 'host', '11112.34')
		testXML.writeFile('', 'history', 'hostat', '11112.34')
		p4 = P4()
