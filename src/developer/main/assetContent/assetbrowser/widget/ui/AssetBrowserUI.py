...
"background-image: url(:/images/strip.png);"))
        self.treeViewPath.setFrameShape(QtGui.QFrame.NoFrame)
        self.treeViewPath.setFrameShadow(QtGui.QFrame.Raised)
        self.treeViewPath.setLineWidth(6)
        ...
        self.listWidget = QtGui.QListWidget(self.layoutWidget_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listWidget.sizePolicy().hasHeightForWidth())
        self.listWidget.setSizePolicy(sizePolicy)
        self.listWidget.setStyleSheet(_fromUtf8("background-color: qlineargradient(spread:repeat, x1:0.472224, y1:1, x2:0.468, y2:0, stop:0 rgba(34, 34, 34, 255), stop:1 rgba(102, 102, 102, 255));\n"
"\n"
"color: rgb(255, 255, 255);\n"
"background-image: url(:/images/strip.png);"))
