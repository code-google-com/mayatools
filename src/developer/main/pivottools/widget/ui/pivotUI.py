...
# Form implementation generated from reading ui file 'Z:\ge_Tools\src\developer\main\pivottoolbox\basicpivottools\widget\ui\pivotUI.ui'
#
# Created: Fri Jul 11 13:43:12 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/YMid.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbYmid.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/X.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbX.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/ZMid.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbZmid.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/Y.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbY.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/XMid.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbXmid.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/ZMin.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbZmin.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/XMax.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbXmax.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/YMin.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbYmin.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/YMax.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbYmax.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/ZMax.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbZmax.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/Z.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbZ.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/XMin.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.rdbXmin.setIcon(icon11)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Pivot Adjustment", None))
        self.btnPivottoCenterElement.setToolTip(_translate("MainWindow", "Center to element", None))
        self.btnPivottoCenterElement.setText(_translate("MainWindow", "Pivot to Center", None))
        self.btnCenterPivot.setToolTip(_translate("MainWindow", "Center object", None))
        self.btnCenterPivot.setText(_translate("MainWindow", "Pivot to Center Obj", None))
        self.btnPivottoOrigin.setToolTip(_translate("MainWindow", "Pivot to origin", None))
        self.btnPivottoOrigin.setText(_translate("MainWindow", "Pivot to Origin", None))
        self.btnPivottoanotherObj.setToolTip(_translate("MainWindow", "Pivot to object", None))
        self.btnPivottoanotherObj.setText(_translate("MainWindow", "Pivot to  Obj", None))
